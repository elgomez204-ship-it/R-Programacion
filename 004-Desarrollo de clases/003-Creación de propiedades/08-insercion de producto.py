...
while True:
  ...
  if opcion == 1:
    ...
    libro1 = Libro()           # Creo una nueva instancia de la clase
    libro1.titulo = input("Introduce el título del libro: ")   # Escribo la propiedad
    libro1.autor = input("Introduce el autor del libro: ")   # Escribo la propiedad
    libro1.precio = float(input("Introduce el precio del libro: "))   # Escribo la propiedad
    libros.append(libro1)      # Y a la la lista de libros le añado el libro
  elif opcion == 2:
